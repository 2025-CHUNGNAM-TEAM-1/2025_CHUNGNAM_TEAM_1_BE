package org.chungnamthon.zeroroad.global.oauth2.service;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.chungnamthon.zeroroad.domain.member.entity.Member;
import org.chungnamthon.zeroroad.domain.member.entity.SocialType;
...
import org.chungnamthon.zeroroad.global.oauth2.userinfo.OAuth2UserInfo;
import org.chungnamthon.zeroroad.global.oauth2.userinfo.impl.KakaoOAuth2UserInfo;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private Member updateMember(Member member, OAuth2UserInfo userInfo) {
        member.updateBasicProfile(userInfo.getName(), userInfo.getProfileUrl());
